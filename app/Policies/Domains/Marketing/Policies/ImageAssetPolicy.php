...
use App\Models\Domains\Marketing\Models\ImageAsset;
use App\Models\User;
...
class ImageAssetPolicy
{
     ...
     */
    public function restore(User $user, ImageAsset $imageAsset): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, ImageAsset $imageAsset): bool
    {
        return false;
    }
}
